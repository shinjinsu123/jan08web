...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section>
            ...
            <button type="button" class="btn btn-success">그린이조아</button>
            </div>
            
            <div class="container bg-info text-black">
            	구역
            	<div class="m-5 mb-0 bg-primary">
            		구역 2
            	</div>
            	<div class="mx-2 my-4 py-5 bg-secondary">
            		구역 3
            	</div>
            	<div class="my-2 bg-secondary w-25">
            		구역 4
            	</div>
            	<div class="my-2 bg-secondary w-50">
            		구역 5
            	</div>
            	<div class="my-2 bg-secondary w-75">
            		구역 6
            	</div>
